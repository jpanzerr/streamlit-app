...
= keras.models.load_model('model_all.h5', custom_objects={'mse':
...
keras.models.load_model('model_all.h5')
...
# Will be overwritten by user input
...
= st.number_input("Ground Living Area (sq ft)", min_value=300,
